# -*- coding: utf-8 -*-
#
# bw2-regional documentation build configuration file, created by
...
htmlhelp_basename = 'bw2-regionaldoc'
...
latex_documents = [
  ('index', 'bw2-regional.tex', u'bw2-regional Documentation',
...
man_pages = [
    ('index', 'bw2-regional', u'bw2-regional Documentation',
     [u'Chris Mutel'], 1)
]
...
texinfo_documents = [
  ('index', 'bw2-regional', u'bw2-regional Documentation',
   u'Chris Mutel', 'bw2-regional', 'One line description of project.',
   'Miscellaneous'),
]
